...
const mockTokenomicsData = {
  ...
  currentSupply: 78654321000, // 78.65 billion
  burned: {
    total: 21345679000, // 21.35 billion
    lastBurn: 532000000, // 532 million
    lastBurnDate: "08.03.2025 14:30", // Date of last burn
  },
  buyback: {
    totalUSDT: 1245780, // 1.24 million USDT spent on buyback
    lastAmount: 75000, // 75k USDT in last buyback
    lastDate: "07.03.2025 09:15", // Date of last buyback
    tokensBought: 9876543210, // 9.87 billion tokens bought back and burned
  },
  circulation: {
    available: 43257890000, // ~43.26 billion in circulation
    staking: 35396431000, // ~35.4 billion in staking
    stakingWallets: 7841, // Number of wallets staking
  },
  platform: {
    dailyUsers: 12345, // Daily active users
    dailyGames: 87654, // Games played daily
    usdtVolume: 975000, // Daily USDT volume
    epvpVolume: 3250000000, // Daily ePVP volume
  },
  // Projected token value data (for the chart)
  projectedValueGrowth: [
    { month: 'Mar 25', tokenPrice: 0.0001, supplyLeft: 78.7 },
    { month: 'Jun 25', tokenPrice: 0.00013, supplyLeft: 72.3 },
    { month: 'Sep 25', tokenPrice: 0.00018, supplyLeft: 66.1 },
    { month: 'Dec 25', tokenPrice: 0.00025, supplyLeft: 59.8 },
    { month: 'Mar 26', tokenPrice: 0.00035, supplyLeft: 53.2 },
    { month: 'Jun 26', tokenPrice: 0.00048, supplyLeft: 46.7 },
    { month: 'Sep 26', tokenPrice: 0.00067, supplyLeft: 40.1 },
    { month: 'Dec 26', tokenPrice: 0.00092, supplyLeft: 33.5 },
    { month: 'Mar 27', tokenPrice: 0.00127, supplyLeft: 27.0 },
    { month: 'Jun 27', tokenPrice: 0.00175, supplyLeft: 20.5 },
    { month: 'Sep 27', tokenPrice: 0.00241, supplyLeft: 14.0 },
    { month: 'Dec 27', tokenPrice: 0.00332, supplyLeft: 7.5 },
  ],
  // Burn history data (for the burn chart)
  burnHistory: [
    { month: 'Mar 25', amount: 532 },
    { month: 'Feb 25', amount: 487 },
    { month: 'Jan 25', amount: 412 },
    { month: 'Dec 24', amount: 511 },
    { month: 'Nov 24', amount: 375 },
    { month: 'Oct 24', amount: 428 },
    { month: 'Sep 24', amount: 392 },
    { month: 'Aug 24', amount: 351 },
  ]
};
        ...
        <div className="bg-gray-800 p-3 border border-gray-700 rounded-md">
          ...
          {payload.map((entry, index) => (
            <p key={`item-${index}`} style={{ color: entry.color }} className="flex items-center text-sm">
              ...
              {entry.name}: {entry.value} {entry.name === 'Token Price' ? 'USDT' : 'Billion'}
            </p>
          ))}
        </div>
      );
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 mb-8">
        ...
        <div className="flex justify-between mt-6 text-sm text-gray-400">
          <div className="flex items-center">
            ...
            <span>Token Supply - Billions of ePVP (decreasing over time due to burns)</span>
          </div>
          <div className="flex items-center">
          ...
          <div className="flex justify-between mt-4">
            ...
            <div className="text-sm text-gray-400 text-right">
              ...
              <div className="text-red-400">
                {formatNumber(data.burnHistory.reduce((acc, curr) => acc + curr.amount, 0) * 1000000 / data.burnHistory.length)}
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mt-8 bg-gray-750 rounded-lg p-4 border border-gray-700 text-sm text-gray-400">
        ...
        <p className="mb-2">
          Our platform implements a systematic token burn mechanism where we regularly remove ePVP from circulation, 
          reducing the total supply. Additionally, we conduct regular buybacks using platform revenue to purchase 
          ePVP from the market and burn them permanently.
        </p>
        <p>
