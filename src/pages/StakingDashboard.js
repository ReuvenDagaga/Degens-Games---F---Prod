    ...
    <div className="bg-gray-900 rounded-lg shadow-xl overflow-hidden border border-gray-800">
      <div className="p-6 bg-gradient-to-r from-gray-800 to-gray-900">
        ...
        <p className="text-gray-400">
          Earn rewards on your ePVP tokens automatically
        </p>
      </div>
      ...
      <div className="p-6">
            ...
            <div className="flex-1">
              ...
              <div className="mt-2 h-1.5 bg-gray-700 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${((user.refferedUsers?.length || 0) / 50) * 100}%`,
                  }}
                ></div>
              </div>
            </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex flex-col items-end">
              ...
              <div className="text-lg font-medium text-green-400">
                +{formatNumber((displayBalance * (currentAPY / 100)) / 365)}{" "}
                ePVP
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 text-sm text-gray-400 flex items-start p-4 bg-gray-800 rounded-lg border border-gray-700">
          ...
          <p>
            Your ePVP balance is automatically staked and generates rewards in
            real-time. The more you participate in the platform, the higher your
            APY. Rewards are calculated and added to your balance every quarter
            second.
          </p>
        </div>
      </div>
