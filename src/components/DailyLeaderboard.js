        ...
        <div className="flex flex-wrap gap-4">
            ...
            <div>
              ...
              <div className="text-sm font-semibold text-white">
                <span className="text-green-400 flex items-center">
                  <DollarSign size={14} className="mr-0.5" />100 USDT
                </span>
          ...
          <div className="flex items-center bg-gray-750 rounded-md px-3 py-2 border border-gray-700">
            ...
            <div>
              ...
              <div className="text-sm font-semibold text-white">
                <span className="text-green-400 flex items-center">
                  <DollarSign size={14} className="mr-0.5" />50 USDT
                </span>
                <span className="text-yellow-400 text-xs">+1000 ePVP</span>
              </div>
            </div>
          ...
          <div className="flex items-center bg-gray-750 rounded-md px-3 py-2 border border-gray-700">
            ...
            <div>
              ...
              <div className="text-sm font-semibold text-white">
                <span className="text-green-400 flex items-center">
                  <DollarSign size={14} className="mr-0.5" />25 USDT
                </span>
                <span className="text-yellow-400 text-xs">+1000 ePVP</span>
              </div>
            </div>
          ...
          <div className="flex items-center bg-gray-750 rounded-md px-3 py-2 border border-gray-700">
            ...
            <div>
              ...
              <div className="text-sm font-semibold text-white">
                <span className="text-purple-400">Raffle for $100 USDT</span>
                <span className="text-yellow-400 text-xs">+1000 ePVP</span>
              </div>
            </div>
          </div>
